...
export const commands = {
  ...
  awaitInitialization: (events: Channel<InitStep>) =>
  ...
  setDisplayBackend: (backend: LinuxDisplayBackend) =>
    __TAURI_INVOKE<null>("set_display_backend", { backend }),
  parseMarkdownCommand: (markdown: string) =>
    __TAURI_INVOKE<string>("parse_markdown_command", { markdown }),
  checkAppExists: (appName: string) => __TAURI_INVOKE<boolean>("check_app_exists", { appName }),
  wslPath: (path: string, mode: WslPathMode | null) =>
  ...
  eadFetch: (input: EadFetchInput) => __TAURI_INVOKE<EadFetchOutput>("ead_fetch", { input }),
}
