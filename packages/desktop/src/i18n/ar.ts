export const dict = {
  ...
  "desktop.updater.none.message": "أنت تستخدم بالفعل أحدث إصدار من KloudCode",
  ...
  "desktop.updater.downloaded.prompt": "تم تنزيل إصدار {{version}} من KloudCode، هل ترغب في تثبيته وإعادة تشغيله؟",
  ...
  "desktop.menu.help.documentation": "وثائق KloudCode",
  ...
  "desktop.cli.error.sidecarMissing": "ملف KloudCode CLI الثنائي مفقود. حاول إعادة تثبيت تطبيق سطح المكتب.",
