export const dict = {
  ...
  "desktop.updater.none.message": "你已在使用最新版的 KloudCode",
  ...
  "desktop.updater.downloaded.prompt": "已下載 KloudCode {{version}} 版本，是否安裝並重新啟動？",
  ...
  "desktop.menu.help.documentation": "KloudCode 文件",
  ...
  "desktop.cli.error.sidecarMissing": "KloudCode CLI 執行檔遺失。請嘗試重新安裝桌面應用程式。",
