export const dict = {
  ...
  "desktop.updater.none.message": "Već koristiš najnoviju verziju KloudCode-a",
  ...
  "desktop.updater.downloaded.prompt":
    "Verzija {{version}} KloudCode-a je preuzeta. Želiš li da je instaliraš i ponovo pokreneš aplikaciju?",
  ...
  "desktop.menu.help.documentation": "KloudCode Dokumentacija",
  ...
  "desktop.cli.error.sidecarMissing":
    "Nedostaje binarna datoteka KloudCode CLI-a. Pokušaj ponovo instalirati desktop aplikaciju.",
