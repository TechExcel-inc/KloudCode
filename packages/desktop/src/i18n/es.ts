export const dict = {
  ...
  "desktop.updater.none.message": "Ya estás usando la versión más reciente de KloudCode",
  ...
  "desktop.updater.downloaded.prompt":
    "Se ha descargado la versión {{version}} de KloudCode. ¿Quieres instalarla y reiniciar?",
  ...
  "desktop.menu.help.documentation": "Documentación de KloudCode",
  ...
  "desktop.cli.error.sidecarMissing":
    "Falta el binario de la CLI de KloudCode. Intenta reinstalar la aplicación de escritorio.",
