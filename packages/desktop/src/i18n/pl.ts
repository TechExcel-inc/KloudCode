export const dict = {
  ...
  "desktop.updater.none.message": "Korzystasz już z najnowszej wersji KloudCode",
  ...
  "desktop.updater.downloaded.prompt":
    "Pobrano wersję {{version}} KloudCode. Czy chcesz ją zainstalować i uruchomić ponownie?",
  ...
  "desktop.menu.help.documentation": "Dokumentacja KloudCode",
  ...
  "desktop.cli.error.sidecarMissing":
    "Brakuje pliku binarnego KloudCode CLI. Spróbuj ponownie zainstalować aplikację na komputer.",
