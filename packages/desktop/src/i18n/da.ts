export const dict = {
  ...
  "desktop.updater.none.message": "Du bruger allerede den nyeste version af KloudCode",
  ...
  "desktop.updater.downloaded.prompt":
    "Version {{version}} af KloudCode er blevet downloadet. Vil du installere den og genstarte?",
  ...
  "desktop.menu.help.documentation": "KloudCode Dokumentation",
  ...
  "desktop.cli.error.sidecarMissing": "KloudCode CLI-binærfil mangler. Prøv at geninstallere desktop-appen.",
