export const dict = {
  ...
  "desktop.updater.none.message": "すでに最新バージョンの KloudCode を使用しています",
  ...
  "desktop.updater.downloaded.prompt":
    "KloudCode のバージョン {{version}} がダウンロードされました。インストールして再起動しますか？",
  ...
  "desktop.menu.help.documentation": "KloudCode ドキュメント",
  ...
  "desktop.cli.error.sidecarMissing":
    "KloudCode CLI のバイナリが見つかりません。デスクトップアプリを再インストールしてみてください。",
