export const dict = {
  ...
  "desktop.updater.none.message": "Sie verwenden bereits die neueste Version von KloudCode",
  ...
  "desktop.updater.downloaded.prompt":
    "Version {{version}} von KloudCode wurde heruntergeladen. Möchten Sie sie installieren und neu starten?",
  ...
  "desktop.cli.error.sidecarMissing":
    "Das KloudCode CLI-Binary fehlt. Versuchen Sie, die Desktop-App neu zu installieren.",
