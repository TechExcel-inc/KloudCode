export const dict = {
  ...
  "desktop.updater.none.message": "Você já está usando a versão mais recente do KloudCode",
  ...
  "desktop.updater.downloaded.prompt":
    "A versão {{version}} do KloudCode foi baixada. Você gostaria de instalá-la e reiniciar?",
  ...
  "desktop.menu.help.documentation": "Documentação do KloudCode",
  ...
  "desktop.cli.error.sidecarMissing":
    "O binário da CLI do KloudCode está ausente. Tente reinstalar o aplicativo de desktop.",
