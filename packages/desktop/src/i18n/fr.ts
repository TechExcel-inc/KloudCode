export const dict = {
  ...
  "desktop.updater.none.message": "Vous utilisez déjà la dernière version de KloudCode",
  ...
  "desktop.updater.downloaded.prompt":
    "La version {{version}} de KloudCode a été téléchargée. Voulez-vous l'installer et redémarrer ?",
  ...
  "desktop.menu.help.documentation": "Documentation de KloudCode",
  ...
  "desktop.cli.error.sidecarMissing":
    "Le binaire de la CLI KloudCode est manquant. Essayez de réinstaller l'application de bureau.",
