export const dict = {
  ...
  "desktop.menu.help.documentation": "KloudCode Documentation",
  ...
  "desktop.updater.none.message": "You are already using the latest version of KloudCode",
  ...
  "desktop.updater.downloaded.prompt":
    "Version {{version}} of KloudCode has been downloaded, would you like to install it and relaunch?",
  ...
  "desktop.cli.error.sidecarMissing": "KloudCode CLI binary is missing. Try reinstalling the desktop app.",
