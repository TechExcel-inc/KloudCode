export const dict = {
  ...
  "desktop.updater.none.message": "Du bruker allerede den nyeste versjonen av KloudCode",
  ...
  "desktop.updater.downloaded.prompt":
    "Versjon {{version}} av KloudCode er lastet ned. Vil du installere den og starte på nytt?",
  ...
  "desktop.menu.help.documentation": "KloudCode Dokumentasjon",
  ...
  "desktop.cli.error.sidecarMissing": "KloudCode CLI-binærfil mangler. Prøv å installere skrivebordsappen på nytt.",
