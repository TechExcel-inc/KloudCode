export const dict = {
  ...
  "settings.ead.serverUrl.description": "Production web app used by Pilot iframe.",
  "settings.ead.apiUrl.title": "API URL",
  "settings.ead.apiUrl.description": "Production API used by EAD Map.",
  ...
  "settings.ead.mcp.description": "Register eadpfm with the running OpenCode server (needs node + MCP entry path).",
