export const dict = {
  ...
  "command.ead.map.toggle": "Toggle EAD Map",
  "command.ead.pilot.toggle": "Toggle EAD Pilot",
  "command.ead.pilot.open": "Open EAD AI Pilot",
  "command.ead.context.copy": "Copy EAD active context to composer",
  "command.ead.source.find": "EAD AI Find / Create",
  "command.ead.source.create": "Analyze & Create EAD from source",
  "command.ead.map.setup": "Setup EAD Map",
  "command.ead.mcp.repair": "Repair EAD MCP setup",
  "command.ead.map.mindmap": "Open EAD PFM mindmap filter",
  ...
  "dialog.model.unpaid.freeModels.title": "Free models provided by KloudCode",
  ...
  "provider.connect.apiKey.description":
    "Enter your {{provider}} API key to connect your account and use {{provider}} models in KloudCode.",
  ...
  "provider.connect.oauth.code.visit.suffix":
    " to collect your authorization code to connect your account and use {{provider}} models in KloudCode.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " and enter the code below to connect your account and use {{provider}} models in KloudCode.",
  ...
  "dialog.server.description": "Switch which KloudCode server this app connects to.",
  ...
  "toast.update.description": "A new version of KloudCode ({{version}}) is now available to install.",
  ...
  "error.page.report.prefix": "Please report this error to the KloudCode team",
  ...
  "error.chain.mcpFailed": 'MCP server "{{name}}" failed. Note, KloudCode does not support MCP authentication yet.',
  ...
  "sidebar.gettingStarted.line1": "KloudCode includes free models so you can start immediately.",
  ...
  "app.name.desktop": "KloudCode Desktop",
  ...
  "settings.desktop.wsl.description": "Run the KloudCode server inside WSL on Windows.",
  ...
  "settings.general.row.language.description": "Change the display language for KloudCode",
  "settings.general.row.appearance.title": "Appearance",
  "settings.general.row.appearance.description": "Customise how KloudCode looks on your device",
  "settings.general.row.colorScheme.title": "Color scheme",
  "settings.general.row.colorScheme.description": "Choose whether KloudCode follows the system, light, or dark theme",
  "settings.general.row.theme.title": "Theme",
  "settings.general.row.theme.description": "Customise how KloudCode is themed.",
  ...
  "settings.updates.row.startup.description": "Automatically check for updates when KloudCode launches",
  ...
  "settings.updates.toast.latest.description": "You're running the latest version of KloudCode.",
  ...
  "settings.ead.description": "Connect to EAD PFM (eadfm.com). Sign in from the EAD Map panel or paste a token here.",
  "settings.ead.serverUrl.title": "App URL",
  "settings.ead.serverUrl.description": "Web app used by the Pilot iframe.",
  "settings.ead.apiUrl.title": "API URL",
  "settings.ead.apiUrl.description": "API used by EAD Map.",
  "settings.ead.env.title": "Environment",
  "settings.ead.env.description": "Production (eadfm.com) or local Vite + API.",
  "settings.ead.token.title": "Auth token",
  "settings.ead.token.description": "Bearer token stored after sign-in. Used for Map API and Pilot sync.",
  "settings.ead.token.clear": "Clear",
  ...
  "settings.ead.mcp.ok.title": "MCP connected",
  "settings.ead.mcp.ok.description": "eadpfm was added and connected.",
  "settings.ead.mcp.fail.title": "MCP failed",
  "settings.ead.mcpEntry.title": "MCP entry",
  "settings.ead.mcpEntry.description": "Absolute path to mcp-eadpfm/dist/index.js",
